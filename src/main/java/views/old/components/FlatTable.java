...
import views.old.components.table.FlatButtonRenderTable;
import views.old.components.table.HeaderRenderFlatTable;
...
public class FlatTable extends JTable {
    ...
    public void setFixedWidth(int i, int width) {
